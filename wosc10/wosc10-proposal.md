...
### Similar Workshops
Since WoSC has been the first academic workshop dedicated to Serverless Computing that has more than one edition. As far as we know in 2024 there are two other serverless workshop: [SESAME 2024](https://sesame24.github.io/) Workshop on SErverless Systems, Applications and MEthodologies co-located with EuroSys 2024 
and [WORDS 2023](https://www.wordsworkshop.org/) The Fourth Workshop On Resource Disaggregation and Serverless Computing.
